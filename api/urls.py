...
from api.views.guide_views.diseases_views import DiseaseDetailsView, DiseaseFetch2Randoms, DiseasesViewAll, DiseaseChemicalControls, DiseaseSearchView
...
urlpatterns = [
    ...
    path('devices/<int:device_id>/disease-detections/', DeviceDiseaseDetectionView.as_view(), name='device-disease-detections'),
